    ...
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Publishers != null ? 
                          ...
                          Problem("Entity set 'BookDbContext.Publishers'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Pid,Publisher1")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Pid,Publisher1")] Publisher publisher)
        {
            if (id != publisher.Pid)
            {
                return NotFound();
