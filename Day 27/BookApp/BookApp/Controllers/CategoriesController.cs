...
namespace BookApp.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cid,Category1")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cid,Category1")] Category category)
        {
            if (id != category.Cid)
            {
                return NotFound();
