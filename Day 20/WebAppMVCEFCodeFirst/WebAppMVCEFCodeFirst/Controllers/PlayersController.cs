...
namespace WebAppMVCEFCodeFirst.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlayerId,PlayerName,PlayerTeam,Average,PlayerType")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlayerId,PlayerName,PlayerTeam,Average,PlayerType")] Player player)
        {
