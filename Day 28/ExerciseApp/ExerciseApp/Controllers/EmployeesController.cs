...
namespace ExerciseApp.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Salary,DOJ")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Salary,DOJ")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
