...
namespace WebAppEfCodeFirst.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fname,Lname,Salary,DOJ")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fname,Lname,Salary,DOJ")] Employee employee)
        {
            if (id != employee.Id)
            {
                return NotFound();
